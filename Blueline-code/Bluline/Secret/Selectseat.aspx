<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="~/Secret/selectseat.aspx.cs" Inherits="starselectseet2" Title="BlueLine:Book Tickets Now" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" height="27">
                                                            <asp:DropDownList CssClass="form" ID="Source" runat="server">
                                                                <asp:ListItem Text="Eldoret" Value="Eldoret"></asp:ListItem>
                                                                 <asp:ListItem Text="Nanyuki" Value="Nanyuki"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                    ...
                                                                    <div id="txtHint">
                                                                        <asp:DropDownList CssClass="form" tyle="width: 130px" ID="Destination" runat="server" 
                                                                            ...
                                                                            <asp:ListItem Text="Kisumu" Value="Kisumu"></asp:ListItem>
                                                                             <asp:ListItem Text="Eldoret" Value="Eldoret"></asp:ListItem>
                                                                            <asp:ListItem Text="Nanyuki" Value="Nanyuki"></asp:ListItem>
                                                                            <asp:ListItem Text="Naivasha" Value="Naivasha"></asp:ListItem>
                                                                            ...
                                                                            <asp:ListItem Text="Thika" Value="Thika"></asp:ListItem>
