<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StatusChange.aspx.cs" Inherits="AdminArea_StatusChange" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table align="center">
        <tr>
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Tickets" Font-Size= "X-Large"  
                                            ...
                                            <tbody>                                                
                                                <tr>
                                                    <td colspan="2" height="25">
                                                        <strong>Enter The Ticket number:</strong>
                                                    </td>
                                                    ...
                                                    <table cellspacing="2" cellpadding="2" border="0" style="border:2px solid gray;padding:15px; ">
                                                        <tbody  align="left"  >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:Button ID="btnTravel" runat="server" Text =" Travel " onclick="btnTravel_Click" />
                                                                </td></tr>
