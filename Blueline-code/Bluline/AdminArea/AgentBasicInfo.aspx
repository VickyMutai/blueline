<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AgentBasicInfo.aspx.cs" Inherits="AgentBasicInfo" Title="BlueLine: AgentBasicInfo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <table border="0" align="left" style="text-align:left">
        ...
        <tr>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblshopname" runat="server" AssociatedControlID="txtshopname">Station Name:</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblshopadd" runat="server" AssociatedControlID="txtshopadd">Station Adderss:</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblcity" runat="server" AssociatedControlID="txtcity">Town:</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblph" runat="server" AssociatedControlID="txtph">Station Phone Number:</asp:Label>
                </td>
                <td>
