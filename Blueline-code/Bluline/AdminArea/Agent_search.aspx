<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Agent_search.aspx.cs" Inherits="AdminArea_Agent_search" Title="BlueLine:Search Agent" %>
                ...
                <td>
                    <asp:Panel ID="pnl" runat="server">
                        <table style="border:2px solid #F5F5F5">                            
                                <tr>
                                <td align="center" colspan="4" height="33" style="color: blue; font-size: x-large; font-weight:bold; margin-bottom:15px">
                                                Search Agent
                                            </td>   
                                </tr>
                        ...
                        <table width="285px" border="0">
                            <caption>
                                <tr>
                                            ...
                                            <td align="center" colspan="3" style="color:blue; font-size: x-large; font-weight:bold">
                                                Agent Information
                                            </td>
