<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="Search_byuser.aspx.cs" Inherits="Search_user" Title="BlueLine:Search Tickets" %>
            ...
            <td>
                <!-- Left Table Start-->
                            ...
                            <table cellspacing="0" cellpadding="2" border="0" style="vertical-align:top; margin:0 auto;padding-top:25px" align="center">
                             ...
                             <table cellspacing="0" cellpadding="0" border="0" style="width: 100%; height: 405px;">
                    <tbody>
                        <tr>
                            <!--Center Side Start -->
                            <td>            
